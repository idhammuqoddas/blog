...
var soalising =[
    ...
    {"t":String.raw`Diketahui matriks <m>{P=\begin{pmatrix}p&${no4[4]}\\${no4[1]}&${no4[0]}\end{pmatrix}}</m> dan <m>{Q=\begin{pmatrix}${no4[2]}&${no4[3]}\\${no4[5]}&${no4[6]}\end{pmatrix}}</m>. Maka nilai <m>p</m> adalah ....`,"s":`${(no4[2]*no4[6]-no4[3]*no4[5]+no4[1]*no4[4])/no4[0]}`},
    ...
    {"t":String.raw`Bobi membeli ${no9[0]} martabak dan ${no9[1]} burger seharga Rp${no9[0]*no9[5]+no9[1]*no9[6]}.000,00. Andre membeli ${no9[2]} martabak dan ${no9[9]} burger seharga Rp${no9[2]*no9[5]+no9[3]*no9[6]}.000,00.  Harga 1 martabak dan 1 burger adalah ....`,"s":`${(no9[5]+no9[6])*1000}`}
