...
var soalpg = [
    ...
    {"t":String.raw`<m>\begin{pmatrix}${no12[0]}&${no12[1]}\\${no12[2]}&${no12[3]}\end{pmatrix}\cdot \begin{pmatrix}${no12[4]}&${no12[5]}\\${no12[6]}&${no12[7]}\end{pmatrix}=</m> ....`,"s":[String.raw`<m>\begin{pmatrix}${no12[0]*no12[4]+no12[1]*no12[6]}&${no12[0]*no12[5]+no12[1]*no12[7]}\\${no12[2]*no12[4]+no12[3]*no12[6]}&${no12[2]*no12[5]+no12[3]*no12[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no12[0]*no12[4]+no12[1]*no12[6]}&${no12[0]*no12[5]+no12[1]*no12[7]}\\${no12[2]*no12[5]}&${no12[3]*no12[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no12[0]*no12[4]}&${no12[1]*no12[6]}\\${no12[2]*no12[4]+no12[3]*no12[5]}&${no12[2]*no12[6]+no12[3]*no12[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no12[0]*no12[4]}&${no12[0]*no12[6]+no12[1]*no12[7]}\\${no12[2]*no12[6]}&${no12[2]*no12[6]+no12[3]*no12[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no12[0]*no12[4]}&${no12[1]*no12[5]}\\${no12[2]*no12[6]}&${no12[3]*no12[7]}\end{pmatrix}</m>`]},
    {"t":String.raw`<m>\begin{pmatrix}${no14[0]}&${no14[1]}\\${no14[2]}&${no14[3]}\end{pmatrix}\cdot \begin{pmatrix}${no14[4]}&${no14[5]}\\${no14[6]}&${no14[7]}\end{pmatrix}=</m> ....`,"s":[String.raw`<m>\begin{pmatrix}${no14[0]*no14[4]+no14[1]*no14[6]}&${no14[0]*no14[5]+no14[1]*no14[7]}\\${no14[2]*no14[4]+no14[3]*no14[6]}&${no14[2]*no14[5]+no14[3]*no14[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no14[0]*no14[4]+no14[1]*no14[5]}&${no14[0]*no14[6]+no14[1]*no14[7]}\\${no14[2]*no14[6]}&${no14[3]*no14[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no14[0]*no14[4]}&${no14[1]*no14[5]}\\${no14[2]*no14[4]+no14[3]*no14[5]}&${no14[2]*no14[6]+no14[3]*no14[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no14[0]*no14[4]}&${no14[0]*no14[6]+no14[1]*no14[7]}\\${no14[2]*no14[6]}&${no14[2]*no14[6]+no14[3]*no14[7]}\end{pmatrix}</m>`,String.raw`<m>\begin{pmatrix}${no14[0]*no14[4]}&${no14[1]*no14[5]}\\${no14[2]*no14[6]}&${no14[3]*no14[7]}\end{pmatrix}</m>`]},
